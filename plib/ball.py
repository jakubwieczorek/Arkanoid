...
class Ball(QtWidgets.QGraphicsPixmapItem):
    ...
    def __init__(self, parent, x1 = None, y1 = None):
        ...
        pixmap = QtGui.QPixmap("./plib/pix/ball.png")
    ...
    def collidingEvent(self):
        ...
        for i in range(0, len(self.collidingItems())):
            ...
            if type(collidingItems[i]) is rect.Rect or type(collidingItems[i]) is platform.Platform:
                isCollision = True
                ...
                if type(collidingItems[i]) is rect.Rect:
